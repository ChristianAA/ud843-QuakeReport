    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 301){
                ...
                Log.i(LOG_TAG, "HTTP Response 301: URL has permenently moved to HTTPS. Automatically switching...");
                url = createUrl(protocol+"s://"+url.getAuthority()+""+url.getPath()+"?"+url.getQuery());
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setReadTimeout(10000 /* milliseconds */);
                urlConnection.setConnectTimeout(15000 /* milliseconds */);
                urlConnection.setRequestMethod("GET");
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        if (TextUtils.isEmpty(earthquakeJSON)) {
            ...
            for (int i = 0; i < featureArray.length(); i++) {
                    ...
                    JSONObject currentEartquake = featureArray.getJSONObject(i);
